...
const Employees = () => {
  ...
  // Fetch Employees
  const [data, loading, refetch] = useEmployee(
    currentPage,
    limit,
    debouncedSearch
  ...
  return (
    <div className="font-lexend -mt-2">
                  ...
                  <tr key={employee.id} className="bg-gray-100">
                    ...
                    <td className="px-1 py-[1px] border text-center text-sm relative">
                      <div className="dropdown dropdown-bottom dropdown-end relative">
                        ...
                        <ul
                          tabIndex={0}
                          className="dropdown-content bg-base-100 text-start w-24 pl-3 py-2 rounded-md shadow text-sm z-50"
                        >
                          <li>
                            <button
      ...
      <EditEmployeeModal
        ...
        setEditEmployeeModalOpen={setEditEmployeeModalOpen}
      ...
      />
      <ViewEmployee
        isOpen={viewEmployeeModalOpen}
        onClose={closeViewEmployeeModal}
        employee={selectedEmployee}
      />
