    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const data = allContracts.map((contract, index) => ({
          ...
          "Project Type":
            contract.project_type === 1
              ? "Service"
              : contract.project_type === 2
              ? "Product"
              : "Supply & Service",
          ...
          "Hard Copy":
            contract.hard_copy_status === 1 ? "Found" : "Not Found",
        }));
  ...
  return (
    <div className="font-lexend -mt-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          applyFilter("contract_status", e.target.value)
                        }
                        className="mt-1 block w-full border border-gray-300 rounded-md p-1 text-xs"
                      >
                        <option value="">All</option>
                  ...
                  <div className="my-2">
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        onChange={(e) =>
                          applyFilter("signingDateFrom", e.target.value)
                        }
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          applyFilter("signingDateTo", e.target.value)
                        }
                        className="block w-full border border-gray-300 rounded-md p-1 text-xs"
                        placeholder="To"
                      />
                  ...
                  <div className="my-2">
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        onChange={(e) =>
                          applyFilter("effectiveDateFrom", e.target.value)
                        }
                        className="block w-full border border-gray-300 rounded-md p-1 text-xs"
                        placeholder="From"
                      />
                      <input
                        ...
                        onChange={(e) =>
                          applyFilter("effectiveDateTo", e.target.value)
                        }
                        className="block w-full border border-gray-300 rounded-md p-1 text-xs"
                        placeholder="To"
                      />
                  ...
                  <div className="my-2">
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        onChange={(e) =>
                          applyFilter("closingDateFrom", e.target.value)
                        }
                        className="block w-full border border-gray-300 rounded-md p-1 text-xs"
                        placeholder="From"
                      />
                      <input
                        ...
                        onChange={(e) =>
                          applyFilter("closingDateTo", e.target.value)
                        }
                        className="block w-full border border-gray-300 rounded-md p-1 text-xs"
                        placeholder="To"
                      />
      ...
      {loading ? (
        ...
        <>
          <table className="table w-[1390px] border-collapse border">
            <thead>
            ...
            <tbody>
              {contracts.length === 0 ? (
                ...
                contracts.map((contract, index) => (
                  <tr key={contract.id} className="bg-gray-100">
                    ...
                    <td className="px-1 py-1 border text-xs text-center w-24">
                      <span
                        className={`px-1 py-1 font-semibold rounded-md ${
                    ...
                    <td className="px-1 py-1 border text-xs text-center w-20">
                      <span
                        className={`px-1 py-1 font-semibold rounded-md ${
                          contract.scan_copy_status === 1
                            ? "bg-green-500 text-white"
                            : "bg-red-500 text-white"
                        }`}
                      >
      ...
      <EditContractModal
        editContractModalOpen={editContractModalOpen}
        setEditContractModalOpen={setEditContractModalOpen}
