...
const ImportContractModal = ({ isOpen, onClose, onImport }) => {
        ...
        isOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white p-4 rounded-md">
                    <h2 className="font-bold mb-2">Import Contracts</h2>
                    <form onSubmit={handleImport}>
                        ...
                        <button
                            ...
                            <button type="submit" className="bg-blue-500 ml-2 text-white px-2 py-2 rounded-md text-sm">
                                Import
                            </button>
                        </div>
                    </form>
