...
const EditEmployeeModal = ({ editEmployeeModalOpen, setEditEmployeeModalOpen, employee, refetch }) => {
    ...
    const onSubmit = async (data) => {
        ...
        const employeeRes = await axiosSecure.patch(`/employees/${employee._id}`, updatedEmployee);
